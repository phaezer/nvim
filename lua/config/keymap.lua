...
local keys = {
  ...
  { '<leader>wwk', '<cmd>resize +3<cr>',          desc = 'Increase window height', },
  { '<leader>wwj', '<cmd>resize -3<cr>',          desc = 'Decrease window height', },
  { '<leader>wwh', '<cmd>vertical resize +3<cr>', desc = 'Increase window width', },
  { '<leader>wwl', '<cmd>vertical resize -3<cr>', desc = 'Decrease window width', },
  { '<leader>w=',  '<cmd>wincmd =<cr>',           desc = 'Windows Equalize size', },
  { '<a-h>',       '<cmd>wincmd h<cr>',           desc = 'Move window left', },
  { '<a-j>',       '<cmd>wincmd j<cr>',           desc = 'Move window down', },
  { '<a-k>',       '<cmd>wincmd k<cr>',           desc = 'Move window up', },
  { '<a-l>',       '<cmd>wincmd l<cr>',           desc = 'Move window right', },
