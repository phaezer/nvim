  ...
  opts = {
    ...
    guides = {
      ...
      markers = {
        ...
        bottom = icons.table.Bottom,
        middle = icons.table.Middle,
        vertical = icons.table.Vertical,
      },
    },
    ...
    symbol_folding = {
      ...
      markers = { icons.ui.Collapsed, icons.ui.Expanded },
    },
    ...
    symbols = {
      ...
      icon_fetcher = function(kind, _, _) return icons.kind[kind] end,
      icon_source = 'lspkind',
    },
