return {
  ...
  -- config = function()
  --   -- create a keymaps to activate or deactivate the otter buffer
  --   Utils.mapkey('n', '<leader>oa', function()
  --     require('otter').activate()
  --   end, { desc = '[O]tter [A]ctivate' })

  --   Utils.mapkey('n', '<leader>od', function()
  --     require('otter').deactivate()
  --   end, { desc = '[O]tter [D]eactivate' })
  -- end,
}
